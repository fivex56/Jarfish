...
4. ОБЯЗАТЕЛЬНО: если добавил новую команду или изменил поведение бота — обнови справку в bot/commands.py (метод help)
5. Сделай коммит с осмысленным сообщением на русском
